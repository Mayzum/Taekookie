def ImpuestoVehiculosNMVA():
    ...
    for i in range (1, n + 1):
        ...
        print ()
    print ('Valor de categoria 1 es: ' + repr (categoria1))
    print ('Valor de categoria 2 es: ' + repr (categoria2))
    print ('Valor de categoria 3 es: ' + repr (categoria3))
    print ('Valor de impuesto a pagar es: ' + repr (impuestoapagar))
ImpuestoVehiculosNMVA()